...
local function run(msg, matches)
  if matches[1]:lower() == 'thor' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /thor ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "thor" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (thor)",-- Put everything you like :)
    "^[!/]([Tt]hor)"-- Put everything you like :)
    "^([S|s]tats)$",
    "^([S|s]tatslist)$",
    "^([S|s]tats) (group) (%d+)",
    "^([S|s]tats) (thor)",-- Put everything you like :)
    "^([T|t]hor)"-- Put everything you like :)
    }, 
  run = run
}
